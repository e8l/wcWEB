...
module.exports = function () {
  ...
  var init = sub.addParser("init", {
    addHelp: true,
    description: "scaffold"
  });
  init.setDefaults({ command: "init" });

  var gen = sub.addParser("gen", {
    addHelp: true,
  ...
  exclusive.addArgument(["-t", "--es6-to-es5"], {
  ...
  exclusive.addArgument(["-c", "--coffee"], {
